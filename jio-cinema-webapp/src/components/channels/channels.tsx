    ...
    return (
        <>
            <div className={styles.channels}>
                ...
                <img src={channel1} alt='channel'></img>
                <img src={channel2} alt='channel'></img>
                <img src={channel3} alt='channel'></img>
                <img src={channel4} alt='channel'></img>
                <img src={channel5} alt='channel'></img>
                <img src={channel6} alt='channel'></img>
                <img src={channel7} alt='channel'></img>
